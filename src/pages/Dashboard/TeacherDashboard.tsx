...
import { BookOpen, Users, FileText, Calendar, GraduationCap, PlusCircle } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-[#0056b3] to-[#004494] text-white p-6 rounded-lg">
          ...
          <p className="text-blue-100">Teacher Portal - Manage your classes and students</p>
          <p className="text-blue-100">Teacher ID: {mockData.teacher.id}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-[#0056b3]">{mockData.classes.length}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-[#0056b3]">{mockData.teacher.subjects.length}</div>
