...
import RegistrarDashboardLayout from './components/RegistrarDashboardLayout';
    ...
    <RegistrarDashboardLayout>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 text-white p-6 rounded-lg">
          ...
          <p className="text-orange-100">Registrar Portal - Manage student registrations and records</p>
          <p className="text-orange-100">Registrar ID: {mockData.registrar.id}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-600">{mockData.stats.totalStudents}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-500">{mockData.stats.pendingRegistrations}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-500">{mockData.stats.pendingFees}</div>
