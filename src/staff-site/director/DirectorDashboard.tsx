    ...
    <DirectorDashboardLayout>
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6 rounded-lg">
          ...
          <p className="text-purple-100">Director Portal - Strategic oversight and institutional leadership</p>
          <p className="text-purple-100">Director ID: {mockData.director.id}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{mockData.metrics.totalEnrollment}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-600">{mockData.metrics.academicPerformance}%</div>
